...
for (ind.dep in unique(paste(mediation.individual.pairs.resid$independent, mediation.individual.pairs.resid$dependent))) {
  ...
  dependent = ind.dep[2]
  sorting = sort.by.ies(mediation.individual.pairs.resid[mediation.individual.pairs.resid$independent==independent &
                                                           mediation.individual.pairs.resid$dependent==dependent,])
  plot.obj = direct.indirect.plot(mediation.individual.pairs.resid, 
                                       independent, dependent, sorting, ylims=c(-0.1,0.1))
  print(plot.obj)
}
```
