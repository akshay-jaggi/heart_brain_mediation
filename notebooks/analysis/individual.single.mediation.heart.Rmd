...
```{r}
write.csv(large.ind.frame,"tables/analysis/mediation.individual.single.heart.csv")
```
...
```{r}
write.csv(large.ind.frame.residualized,"tables/analysis/mediation.individual.single.heart.residualized.csv")
```