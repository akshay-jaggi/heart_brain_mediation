...
```{r}
heart.ind.frame = bind_rows(ind.results, .id = "mediator")
```
...
## Direct
```{r}
large.des = heart.ind.frame[heart.ind.frame$lhs == 'de',]
large.des$pvalue_adj = p.adjust(large.des$pvalue,'BH')
```
...
```{r}
large.ies = heart.ind.frame[heart.ind.frame$lhs == 'ie',]
large.ies$pvalue_adj = p.adjust(large.ies$pvalue,'BH')
```
...
```{r}
write.csv(heart.ind.frame,"tables/analysis/mediation.individual.single.heart.csv")
```

```{r}
heart.ind.frame.final = dplyr::select(heart.ind.frame, -c('se','z'))
heart.ind.frame.final = heart.ind.frame.final[heart.ind.frame.final$label != '',]
write.csv(heart.ind.frame.final,"tables/final/mediation.individual.single.heart.csv")
```
...
```{r}
heart.ind.frame.residualized = bind_rows(ind.results.residualized, .id = "mediator")
```

```{r}
large.des.residualized = heart.ind.frame.residualized[heart.ind.frame.residualized$lhs == 'de',]
large.des.residualized$pvalue_adj = p.adjust(large.des.residualized$pvalue,'BH')
```
...
```{r}
large.ies.residualized = heart.ind.frame.residualized[heart.ind.frame.residualized$lhs == 'ie',]
large.ies.residualized$pvalue_adj = p.adjust(large.ies.residualized$pvalue,'BH')
```
...
```{r}
heart.ind.frame.residualized.final = dplyr::select(heart.ind.frame.residualized, -c('se','z'))
heart.ind.frame.residualized.final = heart.ind.frame.residualized.final[heart.ind.frame.residualized.final$label != '',]
write.csv(heart.ind.frame.residualized.final,"tables/final/mediation.individual.single.heart.residualized.csv")
```