...
```{r}
med.frame.final = dplyr::select(med.frame, -c('se','z'))
med.frame.final = med.frame.final[med.frame.final$label != '',]
write.csv(med.frame.final,"tables/final/mediation.latents.single.csv")
```
...
```{r}
med.frame.resid.final = dplyr::select(med.frame.resid, -c('se','z'))
med.frame.resid.final = med.frame.resid.final[med.frame.resid.final$label != '',]
write.csv(med.frame.resid.final,"tables/final/mediation.latents.single.residualized.csv")
```
