...
```{r}
brain.ind.frame.final = dplyr::select(brain.ind.frame, -c('se','z'))
brain.ind.frame.final = brain.ind.frame.final[brain.ind.frame.final$label != '',]
write.csv(brain.ind.frame.final,"tables/final/mediation.individual.single.brain.csv")
```
...
ggplot(brain.des.resid, aes(x = feature, y = est.std, fill = feature)) + 
  geom_boxplot() + 
  geom_point( position = position_jitter(0.1)) + 
  ylab("direct effect") + 
  scale_alpha_discrete('significant',labels=c('False','True')) + 
...
```{r}
brain.ind.frame.resid.final = dplyr::select(brain.ind.frame.resid, -c('se','z'))
brain.ind.frame.resid.final = brain.ind.frame.resid.final[brain.ind.frame.resid.final$label != '',]
write.csv(brain.ind.frame.resid.final,"tables/final/mediation.individual.single.brain.residualized.csv")
```
