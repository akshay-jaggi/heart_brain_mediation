...
```{r}
heart.traditional = heart.traditional[,grepl('cmr_LV|f.eid',colnames(heart.traditional))]
```

```{r}
missing_pattern(heart.traditional)
```
...
heart.imaging.final = heart.imaging.final %>% select(f.eid, everything())
```
