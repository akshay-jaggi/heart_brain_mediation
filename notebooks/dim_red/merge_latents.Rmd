...
```{r}
# Set Heart PC2 to have positive be *more intense*
heart.latents$heart_latent_pc2 = - heart.latents$heart_latent_pc2
# Set Heart PC3 to have positive be *more complex*
#heart.latents$heart_latent_pc3 = - heart.latents$heart_latent_pc3
# Set Brain PC1 to have positive be *more FA*
brain.latents$brain_latent_pc1 = - brain.latents$brain_latent_pc1
# Set Brain PC2 to have positive be *more Volume*
