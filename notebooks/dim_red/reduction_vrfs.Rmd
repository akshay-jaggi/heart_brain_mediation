...
gvrf_cfa = cfa(cardio_cfa_input, vrfs.merged,missing='ML')
```
...
colnames(vrfs.cor) = sapply(colnames(vrfs.cor),function(x) strsplit(x,'_')[[1]][2])
heatmap.with.labels(vrfs.cor,min=-10,max=10,label='correlation')
