...
sort.by.ies = function(dataframe) {
  ies = dataframe[dataframe$label=='ie',]
...
direct.indirect.plot = function(plot, independent, dependent, sorting, ylims=c(-0.1,0.05)) {
  plot = plot[plot$independent==independent & plot$dependent==dependent,]
